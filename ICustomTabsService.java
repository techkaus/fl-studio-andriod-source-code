...
public interface ICustomTabsService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        public static class C0025a implements ICustomTabsService {
            ...
            public Bundle extraCommand(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f5a.transact(5, obtain, obtain2, 0);
            ...
            public int postMessage(ICustomTabsCallback iCustomTabsCallback, String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f5a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean requestPostMessageChannel(ICustomTabsCallback iCustomTabsCallback, Uri uri) throws RemoteException {
                ...
                try {
                    ...
                    this.f5a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() == 0) {
                        z = false;
                    }
            ...
            public boolean updateVisuals(ICustomTabsCallback iCustomTabsCallback, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f5a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() == 0) {
                        z = false;
                    }
